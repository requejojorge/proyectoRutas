...
<!--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAFwfIZwaZScoGf8kJqRbVGjmUXDYdnyHY&libraries=places&callback=initAutocomplete"-->
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB8WATS30_d-Am2k5WHWvW0TW-YdRKrK90&libraries=places&callback=mapa_inicio" async defer></script>
                                    ...
                                    <div class="x_title">
                                        <div class="row">
                                            ...
                                            <ul class="nav navbar-right panel_toolbox">
                                                <li><a title="Ver Rutas" data-toggle="modal" data-target="#modal_rutas"  ><img src='../images/camino.png' style="width:2em"></a></li>                                                                                            
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                                        <input type="text" readonly=""  style="background-color: white;border-color: white"                                                                
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" onclick="" class="btn btn-success" aria-hidden="true">Guardar</button>
                                                        </div>
                                            ...
                                            <div id="mdl_punto_partida" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal" id="btn_cli_cerrar">Cerrar</button>
                                                            <button type="button" onclick="" class="btn btn-success" aria-hidden="true">Asginar</button>
                                                        </div>
                                            ...
                                            <div id="mdl_punto_llegada" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal" id="btn_cli_cerrar">Cerrar</button>
                                                            <button type="button" onclick="" class="btn btn-success" aria-hidden="true">Asignar</button>
                                                        </div>
