...
class Helper {
    ...
    public static $DIRECTORIO_PRINCIPAL = "proyecto_framework";

    public static function generarHTMLReporte($htmlDatos, $usuario, $fecha_inicio, $fecha_fin, $titulo) {
        $html .= '
                    <html>
                        <head>
                            <meta charset="utf-8">
                            <table>
                                    <head>
                                        <tr>
                                            <th><img src="../images/logo_2.png" style="width:6em"></th>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;REPORTE ' . $titulo . '</th>
                                        </tr>
                                    </head>
                                </table> 
                                ...
                                Hora&nbsp;&nbsp;&nbsp;:&nbsp;' . date('H:i:s') . ' <br>
                                Fecha de Busqueda: &nbsp; Del ' . $fecha_inicio . ' al ' . $fecha_fin . '<br>                                     
                                Usuario: &nbsp; ' . $usuario . '                                                                                                              
                        </head>
                        <body>';
    ...
    public static function generarHTMLReporte2($htmlDatos, $usuario, $fecha_inicio, $fecha_fin, $titulo,$zona,$val_estado) {
        $html .= '
                    <html>
                        <head>
                            <meta charset="utf-8">
      ...
      public static function generarHTMLReporte3($htmlDatos, $usuario, $fecha_inicio, $fecha_fin, $titulo,$zona) {
        $html .= '
                    <html>
                        <head>
                            <meta charset="utf-8">
    ...
    public static function generarReporte($html_reporte, $tipo_reporte, $nombre_archivo) {
        if ($tipo_reporte == 1) {
            ...
            $archivo_pdf = "../report/" . $nombre_archivo . ".pdf";
